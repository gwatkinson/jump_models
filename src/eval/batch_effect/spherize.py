...
class ZCA_corr(BaseEstimator, TransformerMixin):
    """Refer to https://github.com/jump-cellpainting/2021_Chandrasekaran_submit
    ted/blob/main/benchmark/old_notebooks/3.spherize_profiles.ipynb."""

    def __init__(self, copy=False):
        self.copy = copy

    def estimate_regularization(self, eigenvalue):
        x = list(range(len(eigenvalue)))
