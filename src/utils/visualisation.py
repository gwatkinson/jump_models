...
Inspired from https://github.com/wcipriano/pretty-print-confusion-matrix/blob/master/pretty_confusion_matrix/pretty_confusion_matrix.py#L22
...
def pp_matrix_from_data(
    ...
    predictions (predic), whitout a confusion matrix yet."""
