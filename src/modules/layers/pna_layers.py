# Taken from https://github.com/HannesStark/3DInfomax/blob/master/models/base_layers.py
...
class FCLayer(nn.Module):
    r"""A simple fully connected and customizable layer. This layer is centered
    around a torch.nn.Linear module. The order in which transformations are
    applied is:
