"""A simplified version of e3gnn because CLIP is complex enough :O No decoder,
no coordinates Just dumps the hidden rep."""
import torch
...
class e3gnn_clip(torch.nn.Module):
    def __init__(
        ...
        """The Welling research code is quadratic in batch size. and has no
        instancenorm. This fixes that. This also has no edge feature b/c bonds
        aren't real.
