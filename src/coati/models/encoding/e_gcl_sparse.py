...
class e_gcl_sparse(nn.Module):
    """Equivariant Graph Convolutional layer this differs from the welling
    implementation in.
    ...
    def forward(
        ...
        """
        mij, Is, Js, Ks, Ds = self.edge_model(h, x, node_mask, distance_gradient=distance_gradient, debug=debug)
